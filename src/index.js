...
var secureRandomInt = _shared.secureRandomInt;
var _now = _shared._now;
var _constantTimeEqual = _shared._constantTimeEqual;
...
var _populationStddev = _shared._populationStddev;
var _percentile = _shared._percentile;
var createSanitizer = _shared.createSanitizer;
var sanitize = _shared.sanitize;
var isSafeUrl = _shared.isSafeUrl;
var GIF_MAX_RETRIES = _shared.GIF_MAX_RETRIES;
var GIF_RETRY_DELAY_MS = _shared.GIF_RETRY_DELAY_MS;
var loadGifWithRetry = _shared.loadGifWithRetry;
var textSimilarity = _shared.textSimilarity;
var validateAnswer = _shared.validateAnswer;
var createChallenge = _shared.createChallenge;
var pickChallenges = _shared.pickChallenges;
...
// ── Internationalization (extracted to ./i18n.js) ────────────────
var createI18n = require("./i18n").createI18n;
...
// ── Configuration Validator (extracted to ./config-validator.js) ──
var createConfigValidator = require("./config-validator").createConfigValidator;
var createChallengeAnalytics = require("./config-validator").createChallengeAnalytics;
// ── Geo Risk Scorer (extracted to ./geo-risk-scorer.js) ─────────────
var createGeoRiskScorer = require("./geo-risk-scorer").createGeoRiskScorer;

/* The full createGeoRiskScorer implementation (including _haversineKm,
   DEFAULT_HIGH_RISK, DEFAULT_MEDIUM_RISK, and threshold constants) has
   been extracted to ./geo-risk-scorer.js. */
